        ...
        <div className={`row justify-content-center ${styles.content}`}>
          <div className="col-lg-6">
            <div className="d-flex align-items-center justify-content-center gap-3">
              ...
              <button type="button" className={styles.playButton} onClick={() => handleButtonClick(true)} aria-label="Play course sample">
                <Image src={playButton} alt="Play course sample" priority />
              </button>
            </div>
            <button type="button" className="invisible" tabIndex={-1} />
          </div>
        </div>
      </div>
      {mounted && isOpen
