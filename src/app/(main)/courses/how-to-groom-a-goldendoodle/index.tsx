...
import goldendoodleShaving from './_images/goldendoodle-shaving.png';
import heroBackgroundMobile from './_images/hero-background-mobile.jpg';
...
import remyPupStar from './_images/remy-pup-star.png';
import { WLDSection } from './_wld';
...
export const GoldendoodleCourse: FC<Props> = ({ price, wld }) => (
  <>
...
const faqItems: FAQItem[] = [
  ...
  {
    question: 'How can I become a professional dog groomer after learning to groom my own dog?',
    answer: <>If you've learned to groom your own dog and want to take your skills further, professional training can help you build the knowledge and hands-on skills needed to work with clients. <a href="/courses/professional-training">QC Pet Studies' Dog Grooming Course</a> offers flexible online training led by experienced grooming professionals. You'll learn professional grooming techniques, work with different breeds and coat types, complete practical assignments, and receive personalized feedback to help refine your skills. The course can prepare you to pursue work as a professional groomer or start your own grooming business.</>,
  },
];
