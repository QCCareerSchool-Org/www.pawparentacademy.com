...
export const heroContent = {
  ...
  backgroundImage:
    'https://kajabi-storefronts-production.kajabi-cdn.com/kajabi-storefronts-production/file-uploads/themes/2159797494/settings_images/bebbec1-453c-a00-33a6-f5debb71e7_hero-pug.jpg',
};
...
export const fitChecklistContent = {
  ...
  checklist: [
    ...
    "You want to stay on top of your dog's health and prevent infections.",
    'Learning a new skill with your fur baby sounds like fun.',
  ],
  image: {
    src: 'https://kajabi-storefronts-production.kajabi-cdn.com/kajabi-storefronts-production/file-uploads/themes/2159797494/settings_images/fdb3f1a-6b-4875-48de-4adeff8d2_pug-nadia.jpg',
...
export const mascotSpotlight = {
  ...
  image: {
    src: 'https://kajabi-storefronts-production.kajabi-cdn.com/kajabi-storefronts-production/file-uploads/themes/2159797494/settings_images/268366-07cb-05a5-8486-2fc8b5ed8322_pug-pup-star.jpg',
...
export const modules = [
  {
    ...
    image:
      'https://kajabi-storefronts-production.kajabi-cdn.com/kajabi-storefronts-production/file-uploads/themes/2159797494/settings_images/4b28aa-116-8f41-4f5-8d8ad0674cd6_module-1.jpg',
  },
  {
    title: 'Module 2',
    ...
    image:
      'https://kajabi-storefronts-production.kajabi-cdn.com/kajabi-storefronts-production/file-uploads/themes/2159797494/settings_images/2270448-08d-441d-3e27-235e0f88df46_module-6.jpg',
  },
  {
    title: 'Module 3',
    ...
    image:
      'https://kajabi-storefronts-production.kajabi-cdn.com/kajabi-storefronts-production/file-uploads/themes/2159797494/settings_images/3426f41-8bd7-2f8-07c-8866f800dc1b_module-3.jpg',
  },
  {
    title: 'Module 4',
    ...
    image:
      'https://kajabi-storefronts-production.kajabi-cdn.com/kajabi-storefronts-production/file-uploads/themes/2159797494/settings_images/fb7a-c3b-4cad-ca52-b8d0eca41_module-2.jpg',
  },
  {
    title: 'Module 5',
    ...
    image:
      'https://kajabi-storefronts-production.kajabi-cdn.com/kajabi-storefronts-production/file-uploads/themes/2159797494/settings_images/5430b31-c44e-b382-5200-12066553385_module-4.jpg',
  },
  {
    title: 'Module 6',
    ...
    image:
      'https://kajabi-storefronts-production.kajabi-cdn.com/kajabi-storefronts-production/file-uploads/themes/2159797494/settings_images/ec27c63-5720-16a-0f1b-e0f2747a506_modules-bathing.jpg',
  },
  {
    title: 'Bonus Module',
    ...
    image:
      'https://kajabi-storefronts-production.kajabi-cdn.com/kajabi-storefronts-production/file-uploads/themes/2159797494/settings_images/50653f-3b-3a1a-f2a5-a3644a401da0_module-bonus.jpg',
  },
];
...
export const faqItems: AccordionItem[] = [
  {
    ...
    answerHtml:
      "Not at all! You can learn how to groom your pug with no prior experience grooming dogs. There is no complicated terminology or skipped techniques, and you can watch each demo as often as you like.",
  },
  {
  ...
  },
  {
    ...
    answerHtml:
      "What you invest in your grooming setup depends on how much of the groom you'd like to do. If you're going to bathe and dry your pup you'll invest in dog-safe shampoo, conditioner and a dryer. The upfront investment pays for itself as professional grooming expenses shrink or disappear altogether.",
  },
  {
    question: 'My dog is terrified to go to the groomers. Will this course help?',
    answerHtml:
      'Grooming your dog at home can be the perfect solution if salon visits feel scary. You control the environment, can offer breaks whenever needed, and the course walks you through every step to keep sessions positive.',
  },
  {
    question: 'How can I determine if I have sufficient physical strength to groom my own dog?',
    answerHtml:
      'You will want good grip strength for tool handling and to be comfortable standing for longer periods. The course shares tips for setting up an ergonomic grooming station so both you and your dog stay comfortable.',
  },
  {
    question: 'I have another dog with a different coat type. Will this course teach me everything I need to know?',
    answerHtml:
      'Paw Parent Academy offers a unique course for each coat type. Email <a href="mailto:info@pawparentacademy.com">info@pawparentacademy.com</a> and we will help you pick the right fit and share bundle discounts if you enroll in multiple courses.',
  },
];
