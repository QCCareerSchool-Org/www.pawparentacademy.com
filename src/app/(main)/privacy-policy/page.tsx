    ...
    <div className="container">
      <div className={styles.content}>
        ...
        <div className={styles.sectionBlock}>
          ...
          <p className={styles.note}><strong>Note:</strong> If at any time you would like to unsubscribe from receiving future email, we include detailed unsubscribe instructions at the bottom of each message.</p>
        </div>
