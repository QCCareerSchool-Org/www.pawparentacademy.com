  ...
  <section>
    <div className="container">
      ...
      <ul>
        ...
        <li>To send periodic emails, including order updates plus occasional company news, updates, related product, or service information.</li>
      </ul>
      <div className="alert alert-info"><strong>Note:</strong> If at any time you would like to unsubscribe from receiving future email, we include detailed unsubscribe instructions at the bottom of each message.</div>
